...
class Categories(models.Model):
    ...
    # dice a Django come mostrare questo oggetto — mostra il nome
    def __str__(self):
        return self.nome
...
class Components(models.Model):
    nome = models.CharField(max_length=255)
    categoria = models.ForeignKey(Categories, models.DO_NOTHING, db_column='categoria')
    pezzi = models.IntegerField()
    link = models.CharField(max_length=255)

    # mostra il nome del componente
    def __str__(self):
        return self.nome
...
class Esperienze(models.Model):
    ...
    pdf = models.FileField(upload_to='esperienze_pdf/', blank=True, null=True)
...
class Locations(models.Model):
    ...
    # mostra il nome della locazione
    def __str__(self):
        return self.nome
...
class TagComponents(models.Model):
    ...
    # mostra tag e componente collegati
    def __str__(self):
...
class Tags(models.Model):
    ...
    # mostra la caratteristica del tag
    def __str__(self):
...
class Users(models.Model):
    ...
    # mostra nome e cognome dell'utente
    def __str__(self):
