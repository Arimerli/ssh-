...
function Componenti({ searchQuery, utente }) {
  ...
  const compCorrente =
    coda.length > 0 && indiceCoda < coda.length ? coda[indiceCoda] : null;
    ...
    <div>
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                cursor: "pointer",
                opacity:
                  !quantitaPopup || parseInt(quantitaPopup) <= 0 ? 0.5 : 1,
              }}
            >
              {indiceCoda + 1 < coda.length
                ? "Aggiungi e continua"
                : "Aggiungi alla lista"}
            </button>
          </div>
      ...
      <div className={styles.tagBar}>
        {categoriaFiltro && (
          ...
          >
            <span className={styles.categoriaBadgeLabel}>
