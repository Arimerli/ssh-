...
export const getGiacenzaComponente = (id) =>
  api.get(`/giacenze/?componente=${id}`);

export const aggiornaGiacenza = (id, data) =>
  api.patch(`/giacenze/${id}/`, data);

export const eliminaGiacenza = (id) => api.delete(`/giacenze/${id}/`);

export const aggiornaComponente = (id, data) =>
...
export const aggiornaProfiloUtente = (data) =>
  api.post("/utente/aggiorna-profilo/", data);

export const aggiornaUtente = (id, data) =>
  api.patch(`/utenti/${id}/aggiorna/`, data);

export const eliminaUtente = (id) => api.delete(`/utenti/${id}/elimina/`);
...
export const getEsperienzeComponents = (id) =>
  api.get(`/esperienze-components/?esperienza=${id}`);
...
export const eliminaPosizione = (id) => api.delete(`/locations/${id}/elimina/`);
